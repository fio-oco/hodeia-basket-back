import { Column, Entity, PrimaryGeneratedColumn, BeforeInsert, ManyToMany, JoinTable, ManyToOne, JoinColumn, OneToOne } from 'typeorm';
...
export class User {
  ...
  // rolId: uuid; //this has to match the column in the usuarios table
